...
import at.mogree.spinnerwheel.library.adapters.WheelViewAdapter;
...
public abstract class AbstractWheel extends View {
	...
	protected boolean mIsJustified = false;
	...
	// Listeners
	private List<OnWheelChangedListener> mChangedListeners = new LinkedList<OnWheelChangedListener>();
	private List<OnWheelChangingListener> mChangingListeners = new LinkedList<OnWheelChangingListener>();
	private List<OnWheelScrollListener> mScrollingListeners = new LinkedList<OnWheelScrollListener>();
	private List<OnWheelItemClickedListener> mItemClickedListeners = new LinkedList<OnWheelItemClickedListener>();
		...
		mScroller = createScroller(new WheelScroller.ScrollingListener() {
			...
			public void onFinished() {
				...
				if (mIsScrollingPerformed) {
					if (mIsJustified) {
						mIsJustified = false;
						notifyChangedListeners(0, mCurrentItemIdx);
					}
	 ...
	 */
	protected void setCurrentItem(int index, boolean animated, boolean isFromScroller) {
		...
		if (index != mCurrentItemIdx) {
			if (animated) {
				...
				if (isFromScroller) {
					...
					notifyChangedListeners(old, mCurrentItemIdx);
				}
				invalidate();
			}
		}
	...
	public void setCurrentItem(int index, boolean animated) {
		setCurrentItem(index, animated, false);
	}
	...
	/**
	 * Adds spinnerwheel changed listener
	 *
	 * @param listener the listener
	 */
	public void addOnChangedListener(OnWheelChangedListener listener) {
		mChangedListeners.add(listener);
	}

	/**
	 * Removes spinnerwheel changed listener
	 *
	 * @param listener the listener
	 */
	public void removeOnChangedListener(OnWheelChangedListener listener) {
		mChangedListeners.remove(listener);
	}

	/**
	 * Notifies changed listeners
	 *
	...
	protected void notifyChangedListeners(int oldValue, int newValue) {
		for (OnWheelChangedListener listener : mChangedListeners) {
	 ...
	 * @param listener the listener
	 */
	public void addOnChangingListener(OnWheelChangingListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void removeOnChangingListener(OnWheelChangingListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnWheelChangingListener listener : mChangingListeners) {
			listener.onChanging(this, oldValue, newValue);
		}
	}
	 ...
	 * @param listener the listener
	 */
	public void addOnScrollingListener(OnWheelScrollListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void removeOnScrollingListener(OnWheelScrollListener listener) {
	 ...
	 * @param listener the listener
	 */
	public void addOnItemClickedListener(OnWheelItemClickedListener listener) {
		mItemClickedListeners.add(listener);
	}
	 ...
	 * @param listener the listener
	 */
	public void removeOnItemClickedListener(OnWheelItemClickedListener listener) {
		mItemClickedListeners.remove(listener);
	}
